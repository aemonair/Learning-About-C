...
struct PredIgnoreCase
{
    bool operator ()(const string & str1, const string& str2) const
    {
        ...
        std::transform(str1.begin(), str1.end(), 
                       str1NoCase.begin(),::tolower);
        std::transform(str2.begin(), str2.end(),
                       str2NoCase.begin(),::tolower);
...
int main()
{
    ...
    dirCaseInsensitive.insert(make_pair("Jack", "32435346"));
    ...
    DIRECTORY_WITHCASE dirCaseSensitive(
        dirCaseInsensitive.begin(), dirCaseInsensitive.end());

    cout << "Displaying contents of the case-senstitive map:" << endl;
    ...
    {
        cout << iPairInNoCaseDir->first << "'s number in the case-sensitive";
